  ...
  return (
    ...
    >
      <button
        ...
        className={`bg-greenCustom hover:bg-darkGreen hover:scale-110 text-white p-4 rounded-full shadow-lg transition-all duration-300  ${isClicking ? "translate-y-[-500px]" : ""}`}
      ...
      >
        <div className="relative w-8 h-8">
            <svg 
              ...
              style={{ fill: isHovering ? "#07c381" : '#0cda92', opacity: 0.7 }}>
              <g>
