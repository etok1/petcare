    ...
    reasons: [
      {
        ...
        isActive: true,
        icon: <Trees size={32} color="#4299e1" />,
      },
      {
        name: "Уход и забота",
        text: "Помощь в кормлении и уходе за животными",
        isActive: false,
        icon: <BookHeart size={32} color="#4299e1" />,
      },
      {
        name: "Фотосъёмка",
        text: "Фото питомцев для пристройства",
        isActive: false,
        icon: <Camera size={32} color="#4299e1" />,
      },
    ],
  },
  {
    ...
    reasons: [
      {
        ...
        isActive: true,
        icon: <Bone size={32} color="#FF7700" />,
      },
      {
        name: "Пожертвования",
        text: "Финансовая поддержка приютов",
        isActive: false,
        icon: <HandCoins size={32} color="#FF7700" />,
      },
      {
        name: "Строительство",
        text: "Материалы для ремонта и обустройства",
        isActive: false,
        icon: <Hammer size={32} color="#FF7700" />,
      },
    ],
  },
  {
    ...
    reasons: [
      {
        name: "Пиар животных и приютов",
        text: "Репосты, рассказы о питомцах",
        isActive: true,
        icon: <Speech size={32} color="#059669" />,
      },
      {
        name: "Транспорт",
        text: "Помощь с перевозкой животных",
        isActive: false,
        icon: <Car size={32} color="#059669" />,
      },
      {
        name: "Кураторство",
